...
dash = Button(text='Dashboard', border=0, bg='#363740', fg='white', font=(
    "Inter", 10, "bold"), cursor='hand2', command=dashboard)
dash.place(x=1, y=30)
...
add_medicine = Label(root, text='Add Category',
                     fg='#363740', font=("Poppins", 20, "bold"))
add_medicine.place(x=600, y=150)
info = Label(root, text='Information', fg='#363740',
...
save_button = Button(root, text='SAVE', border=1, width=15, height=2,
                     bg='#3ECF0A', fg='#FAFAFA', font=("Poppins", 10), command=save)
save_button.place(x=880, y=500)
back_button = Button(root, text='BACK', border=1, width=15, height=2,
                     bg='#3ECF0A', fg='#FAFAFA', font=("Poppins", 10), command=back)
