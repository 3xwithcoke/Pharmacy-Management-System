...
def update():
    ...
    def edit():
        ...
        query = 'UPDATE category  SET name=%s WHERE categoryId=%s', (vals['category'], int(
            vals['categoryId']))
    ...
    add_medicine = Label(top, text='Update Category',
    ...
    a = Label(top, text='')
    a.place(x=190, y=230)
    user_name = Label(top, text='category ID',
...
dash = Button(text='Dashboard', width=19, height=2, border=0, bg='#363740',
...
category = Button(text='Category', width=19, height=2, border=0, bg='#595B67',
                  fg='white', font=("Inter", 10, "bold"), cursor='hand2', command=category)
category.place(x=1, y=130)
categoryimg = PhotoImage(file='./assets/category.png')
...
billing = Button(text='Billing', border=0, bg='#363740', fg='white', font=(
...
# ********total product ****************************
total_product = Label(root, text='Total Category:',
                      fg='#363740', font=("Poppins", 17, "bold"))
total_product.place(x=200, y=80)
add_button = Button(root, text='+ Add Category', border=1,
...
product_name = Label(text="Category ID", bg='#D9D9D9',
                     font=("poppins", 12, "bold"))
product_name.place(x=600, y=150)
fees = Label(text="Category", bg='#D9D9D9', font=("poppins", 12, "bold"))
fees.place(x=830, y=150)

Button(root, text='Edit', bg='#FF702A', fg='white', width=6, border=1,
       font=("Poppins", 15), command=update).place(x=870, y=80, height=37)
...
categoryarea = Text(categoryListframe, yscrollcommand=scrolly.set,
